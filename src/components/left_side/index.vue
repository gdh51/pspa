<template>
  <aside id='left-side'>
    <transition name='change-tab'>
      <section class='toggle-info' v-show="this.$store.state.sideBar.isShowToggle">
      <button type='button' v-on:click='changeButton=!changeButton'>Toggle Info</button>
      <polo-hr/>
    </section>
    </transition>
    <transition name='change-tab' mode='out-in' appear>
      <section class='side-info' v-if="changeButton" key='side-info'>
        ...
        <address class='info-links'>
          ...
          <router-link class='info-links-tag' to='/'>Lazybones</router-link>
        </address>
      </section>
